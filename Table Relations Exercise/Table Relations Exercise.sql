...
MODIFY passport_number VARCHAR(30) UNIQUE;
...
(1,"BMW",'1916-03-01'), (2,"Tesla",'2003-01-01'), (3,"Lada",'1966-05-01');
...
INSERT INTO students_exams VALUES (1,101),(1,102),(2,101),
(3,103),(2,102),(2,103);
...
INSERT INTO teachers (name,manager_id) VALUES ('John',null),('Maya',106),
('Silvia',106),('Ted',105),('Mark',101),('Greta',101);
